...
0. Запустить RenaissancePatcher
1. Нажать кнопку "Пропатчить"
2. При успехе появится сообщение об успешном применении патчей
